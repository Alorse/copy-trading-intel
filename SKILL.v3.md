...
author: Alfredo Ortegón Sepúlveda + auditoría adversarial (Fable/Kimi/GLM/Claude)
license: MIT
description: "Scrape Phemex+Binance copy-trading public data for patterns. v3: hallazgos corregidos tras auditoría."
---

> # ⚠️ ESTE ARCHIVO ES UN CANDIDATO, NO LA SKILL ACTIVA
>
> `SKILL.md` (v2.0.0) sigue en su sitio, intacto. Este archivo existe para que **compares y
> decidas**. Ambos describen los mismos endpoints y scripts; difieren en la sección de
> **Hallazgos**, donde v2 contiene seis afirmaciones que la auditoría de 2026-08-25 demostró
> falsas contra su propia data.
>
> Todo lo de aquí es reproducible con los scripts de `analysis/`. Evidencia completa en
> `analysis/FINDINGS_v2.md`, `analysis/RULES.md` y `analysis/TOP5.md`.
>
> **Si adoptas este archivo, renómbralo a `SKILL.md` y archiva el anterior como `SKILL.v2.md`.**
