...
| Bitget | unknown | order history schema known (`rows/totals/nextFlag`) | web-session tokens expire (terminalcode/dy-token/custom-token/uhti); config-file design | unknown |
